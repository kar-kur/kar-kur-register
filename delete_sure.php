...
<script type="text/javascript">
 ...
 <div class="RightBody">
          ...
          <div class="EmailPass">  Good bye <b><?php echo htmlspecialchars($_SESSION['username']); ?>,</b> if you are sure that you want <br> to delete your account, please confirm your <br>Email-Address and Password!</h4>
          </div>
