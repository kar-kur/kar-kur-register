...
<body>
   ...
   <div class="EmailPass">  Change here your Email and / or Password!</div>
      ...
      <form name="RegisterForm" method="post" action="Updated.php">
    <form name="RegisterForm" method="post" action="">
          <div class="FormElement">
           ...
           <div class="FormElement">
         	  <input name="Password" type="password" required class="TField" id="Password" placeholder="New Password" value="<?php  echo $_SESSION["Password"]; ?>" />
         </div>
           <div class="FormElement">
            <input name="Password" type="password" required class="TField" id="Password" placeholder="Confirm new Password" value="<?php  echo $_SESSION["Password"]; ?>" />
         </div>
